      ...
      if (context.props.hideOnLeave) {
        ...
        data.on.afterLeave = mergeTransitions(data.on.afterLeave, function (el) {
          if (el) {
            ...
            el._initialDisplay ? (_el$style = el.style).setProperty.apply(_el$style, ['display'].concat(_toConsumableArray(el._initialDisplay))) : el.style.removeProperty('display');
          }
        });
      }

  ...
  methods: {
    ...
    genDay: function genDay(day, index) {
      return this.$createElement('div', {
        ...
        class: this.getRelativeClasses(day)
      }, [].concat(_toConsumableArray(this.genDayIntervals(index, day)), _toConsumableArray(this.genDayBody(day))));
    },
    genDayBody: function genDayBody(day) {
      var _this3 = this;

      return (0, _helpers.getSlot)(this, 'day-body', function () {
        return _this3.getSlotScope(day);
      }) || [];
    },
    genDayIntervals: function genDayIntervals(index, day) {
      ...
      return this.intervals[index].map(function (i) {
        return _this4.genDayInterval(i, day);
      });
    },

...
class User(BaseModel, Base):
    ...
    matches = relationship("User", foreign_keys="match_id", secondary="user_matches", viewonly=False)
    likes = relationship("User", foreign_keys="like_id", secondary="user_likes", viewonly=False)

...
class User(BaseModel, Base):
    ...
    games = relationship("user_games", secondary="user_games", viewonly=False)
    matches = relationship("user_matches", secondary="user_matchs", viewonly=False)
    likes = relationship("user_likes", secondary="user_likes", viewonly=False)
    socials = relationship("user_socials", secondary="user_socials", viewonly=False)
